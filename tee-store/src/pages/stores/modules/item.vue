...
.c-store-item .box { width: 700px; height: 267px; background: #F9F9F9; box-shadow: 0px 3px 20px 0px rgba(0, 0, 0, 0.08); border-radius: 35px; overflow: hidden; position: relative; }
...
<template>
<div class="c-store-item">
  <div class="box" hover-class="hscale" hover-stay-time="10" @click="toDetail">
  ...
  <button class="btn center" hover-class="hscale" hover-stay-time="10" @click.stop="handleGuide">
