<style>
    ...
    .step2-frame .warn{ min-width: 50px; position: absolute; top: 270px; left: 330px; background-color: #e73828; padding: 10px 15px; border-radius: 5px; z-index: 50; font-size: 12px; color: #fff;}
    .step2-frame .warn:before{ content: ''; width: 10px; height: 10px; border: 5px solid rgba(0,0,0,0); border-right-color: #e73828; position: absolute; top: 50%; left: -10px; margin-top: -5px;}
</style>
        ...
        <div class="frame frame1">
            <div class="scroll">
                <div class="step1">
                    ...
                    <div class="tframe">
                        <div class="ticke-type-list" :class="isEditor ? 'ticke-type-list-readonly' : ''" v-for="(item,index) in typeListData" :key="index">
        ...
        <div class="frame frame2">
            <div class="scroll">
                <div class="step1">
                    <div class="title ml20" style="padding-left: 0;">
                        ...
                        <div class="ques2">
                            <t-ques :redbg="showNoticeError" v-if="isEditor ? showNoticeError : true">
                                ...
                                <ul class="list1" v-if="showNoticeError">
                                    <li v-for="(item,index) in errorData.notify" :key="index" v-if="item != ''"><span>须知 {{index+1}} </span>{{item}}</li>
                                </ul>
                            </t-ques>
                        </div>
                    </div>
                    ...
                    <div class="mt40">
                        <div class="notice-list" v-for="(item,index) in noticeListData" :key="index">
   ...
   methods: {
      ...
      dataInit () {
         ...
         for (let item of classes) {
            let reg = new RegExp(item.select); let isFit = false
         ...
         let notify = editorData.notify; let notifyError = this.errorData.notify
