...
.tabs1 li { height: 100%; flex: 1; font-size: 30px; display: flex; justify-content: center; align-items: center; position: relative; }
...
.blue-box { border: 12px solid #436CB3; border-bottom: none; }
