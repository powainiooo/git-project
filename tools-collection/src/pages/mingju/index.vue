...
.mj-list li h3 { font-size: 24px; color: #FF3600; margin-bottom: 30px; text-align: right; margin-right: 65px; }
.mj-list li div { font-size: 24px; color: #000000; line-height: 40px; padding-left: 80px; position: relative; }
