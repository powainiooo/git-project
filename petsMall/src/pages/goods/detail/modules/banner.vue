<style>
.c-banner { width: 100%; height: 400px;}
...
.c-banner-dots li { width: 8px; height: 8px; border: 1px solid var(--textColor); border-radius: 50%; margin: 0 5px;}
.c-banner-dots li.active { background-color: var(--textColor); }
</style>
