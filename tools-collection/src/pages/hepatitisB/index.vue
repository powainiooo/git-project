...
<div class="container">
  ...
  <div class="consult-frame">
    <div class="blue-frame mb60">
      <h3 class="f30">乙肝五项</h3>
      <p class="f30">{{record.sm}}</p>
    </div>

    <div class="title1">定义</div>
    <div class="consult-table">
      <rich-text :nodes="record.desc" class="f26"></rich-text>
    </div>
    <div class="title1">指标</div>
    <div class="consult-table">
      <rich-text :nodes="record.desc_2" class="f26"></rich-text>
    </div>
    <div class="title1">结果分析</div>
    <div class="consult-table">
      <rich-text :nodes="record.desc_3" class="f26"></rich-text>
    </div>
  </div>
  <operates :id="id" />
</div>
