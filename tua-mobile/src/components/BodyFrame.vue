<style>
    ...
    .nav-frame nav{ width: 70%; position: absolute; top: 0; right: 0; background-color: #fff; padding:0 15px;}
...
<template>
    <section class="body-frame">
        ...
        <transition name="fade">
            <div class="bgCover" v-if="showMenu"></div>
        </transition>
        <transition name="slide">
        <div class="nav-frame" v-if="showMenu">
            <nav>
