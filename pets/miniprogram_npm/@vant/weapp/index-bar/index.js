    ...
    methods: {
        ...
        getActiveAnchorIndex: function () {
            ...
            for (var i = this.children.length - 1; i >= 0; i--) {
                ...
                if (reachTop + scrollTop >= children[i].top - _b.offsetTop) {
                    return i;
                }
            }
            return -1;
        ...
        onClick: function (event) {
            this.scrollToAnchor(event.target.dataset.index, true);
	        this.setData({
		        currentKey: null
	        })
        },
        ...
        onTouchStop: function () {
	        ...
	        var anchor = this.children.find(function (item) {
		        return item.data.index === _this.data.indexList[_this.scrollToAnchorIndex];
	        });
	        if (anchor) {
		        anchor.scrollIntoView(this.scrollTop - _this.data.offsetTop);
        ...
        scrollToAnchor: function (index, isScroll = false) {
            var _this = this;
