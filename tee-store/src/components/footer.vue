...
.c-footer .arrow { width: 100px; position: absolute; top: 0; left: 50%; transform: translate(-50%, -100%); }
</style>

<template>
<div class="c-footer">
  <a href="/pages/stores/main" open-type="redirect" :class="{'active': current === 'order'}">
  ...
  <a href="/pages/nearby/list/main" open-type="redirect" :class="{'active': current === 'store'}">
  ...
  <a href="/pages/order/list/main" open-type="redirect" :class="{'active': current === 'list'}">
    <div class="icon icon1">
