<style>
    ...
    .n-upload .imgs{ width: 100px; height: 100px;box-shadow: 0 2px 3px rgba(0,0,0,0.2); overflow: hidden; border-radius: 5px; display: flex; justify-content: center; align-items: center;}
