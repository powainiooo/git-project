<style>
    .n-ques{ position: relative; z-index: 400; width: 20px; height: 20px; display: inline-block;}
    ...
    .n-ques .hint-frame{ width: 450px; box-sizing: border-box; padding: 40px 30px; background: linear-gradient(165deg, #3052a7, #002aa6 54%,#003db9); border-radius: 10px; position: absolute; left: 30px; top: 0; box-shadow: 0 2px 3px rgba(0,0,0,0.2); display: none;}
    .n-ques .hint-frame-left{ left: auto; right: 30px;}
    ...
    .n-ques .hint-frame .list1 li span{ font-size: 16px; font-weight: bold; margin-right: 6px; font-family: 'Helve';}
    .n-ques .hint-frame .list2 li{ font-size: 14px; color: #ffffff; margin-bottom: 10px;}
