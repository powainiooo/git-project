...
.n-clock .clock-list .clock-item .up{ height: 50%; overflow: hidden; background: linear-gradient(0deg, rgba(235, 234, 234, 1), #FFFFFF); display: flex; align-items: flex-start; justify-content: center; transform-origin: 50% 100%; transform: rotateX(0deg); border-radius: 15px 15px 0 0; box-sizing: border-box;}
